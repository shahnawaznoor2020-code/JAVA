## Java Practice Question – Print and Println Statements
...
- Displaying text to the console using different print methods.
...
### Output Statements
- `System.out.print()`: Prints text without moving the cursor to the next line.
- `System.out.println()`: Prints text and automatically moves the cursor to the next line.
...
The program prints the structured text directly to the console during execution.  
...
- `Program1.java` — Contains the practice question program  
