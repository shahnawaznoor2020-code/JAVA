## Java Practice Question – Area of a Circle
...
The program uses a predefined radius value and displays the calculated area clearly in the console.
...
- Area of a circle: Area = π * r * r (using 3.141592 for π)

### Variable Handling
- Initializing an integer variable (`int`) for the radius
- Performing calculations and storing the result in a double-precision floating-point variable (`double`)
...
The program prints the calculated area directly to the console during execution.  
...
- `Area_of_Circle.java` — Contains the practice question program  
