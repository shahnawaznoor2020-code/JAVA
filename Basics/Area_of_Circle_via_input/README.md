## Java Practice Question – Area of a Circle via Input
...
- Calculate the **area of a circle** based on a user-provided radius.
...
- Area of a circle: Area = π * r * r (using 3.14159 for π)

### Input Handling
- Importing and utilizing `java.util.Scanner` for reading console input
- Accepting double-precision floating-point input (`nextDouble()`) for the radius
