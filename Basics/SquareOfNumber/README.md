## Java Practice Question – Square of a Number
...
- Calculate the **square of a number** provided by the user.

The program takes user input from the console and displays the calculated square clearly.
...
- Square of a number: Square = num * num

### Input Handling
- Importing and utilizing `java.util.Scanner` for reading console input
- Accepting integer input (`nextInt()`) for the base number
- Calculating and displaying the result inline within the standard output statement
